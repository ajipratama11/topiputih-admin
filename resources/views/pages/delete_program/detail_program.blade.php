...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="text-left">
                @if ($program->status == 'Request Hapus')
                <form action="{{route('hapus-program.update', $program->id)}}" method="POST">
                    @csrf
                    @method('put')
                    <button type="submit" class="btn btn-primary"
                        onclick="return confirm('Apakah Anda yakin ingin menghapus program ini?')">Hapus Program</button>
                </form>
                @endif
